...
| Method | Throughput | Latency | Fairness |
|----------|----------:|----------:|----------:|
| Round Robin | 251.73 | 509.25 | 0.7905 |
| Proportional Fair | 112.50 | 215.22 | 0.7239 |
| PPO | 16930.00 | 47610.00 | 0.2000 |
| **DQN (30 UE)** | **17910.00** | **64490.00** | **0.0333** |
| DQN No Replay | 16090.00 | 38480.00 | 0.0667 |
| DQN No Target | 15960.00 | 41330.00 | 0.0667 |
| DQN Simple Reward | 17700.00 | 52160.00 | 0.0667 |
...
| Rank | Scheduler | Throughput |
|------|------------|------------:|
| 🥇 1 | DQN (30 UE) | 17910.00 |
| 🥈 2 | PPO | 16930.00 |
| 🥉 3 | Round Robin | 251.73 |
| 4 | DQN Simple Reward | 17700.00 |
| 5 | DQN No Replay | 16090.00 |
| 6 | DQN No Target | 15960.00 |
| 7 | Proportional Fair | 112.50 |
...
| Component Removed | Throughput Change |
|------------------|------------------:|
| Replay Buffer | -11.31% |
| Target Network | -12.22% |
| Reward Shaping | -1.19% |
...
1. DQN achieved the highest throughput among all evaluated reinforcement learning schedulers.
2. DQN outperformed PPO by approximately 5.8%.
3. Replay Buffer contributed approximately 11.3% throughput improvement.
4. Target Network contributed approximately 12.2% throughput improvement.
5. Reward shaping contributed approximately 1.2% throughput improvement.
6. Checkpoint evaluation confirmed stable learning behavior.
7. No catastrophic forgetting was observed.
8. The current environment provides a strong foundation for future scheduling research and enhancements.